                            ...
                            <hr>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <!-- defer : for accepte diffrent name in every submiunt -->
...
@push('scripts')
    <script src="https://www.paypal.com/sdk/js?client-id=AapwHktxeCfHtY72UBFVK0n4nXDqFjaFmK0IPwbhZupL2GW9IkDi1dFx61x0Q1zCU3lvKW8lbQLt6pNA
&currency=USD"></script>
    <script>
        ...
        onApprove: (data, actions)=>{
            return  actions.order.capture().then(function(orderData){
                ...
                alert('Transaction ${transaction.satus}:${transaction.id}\n\nSee console for all available details');
