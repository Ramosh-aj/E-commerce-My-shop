                        ...
                        @csrf     
                            <div class="row">   
                                ...
                                <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" name="meta_title" class="form-controll"/>
                                </div>
                                <div class="col-md-12 mb-3">
                                        <label>Meta Keyword</label>
                                        <textarea name="meta_keyword" class="form-controll" rows="3"></textarea>
                                </div>
                                <div class="col-md-12 mb-3">
                                        <label>Meta Descrption</label>
                                        <textarea name="meta_description" class="form-controll" rows="3"></textarea>
                                </div>
